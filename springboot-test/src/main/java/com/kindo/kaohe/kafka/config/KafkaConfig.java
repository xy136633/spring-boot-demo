package com.kindo.kaohe.kafka.config;
...
import com.kindo.kaohe.kafka.listener.MyMessageListener;
...
public class KafkaConfig {
    ...
    public Map<String, Object> producerConfigs() {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.2.14:9092");
    ...
    public Map<String, Object> consumerConfigs() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.2.14:9092");
    ...
    public ContainerProperties containerProperties(){
        Pattern topicPattern = Pattern.compile(".*"); //匹配满足正则的topic
